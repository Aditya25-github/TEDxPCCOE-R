        ...
        <div className={styles.footerTop}>
          ...
          <nav className={styles.navigation}>
            <ul className={styles.footerLinks}>
              ...
              <li><a href="#speakers" onClick={(e) => handleLinkClick(e, '#speakers')}>Speakers</a></li>
              <li><a href="#schedule" onClick={(e) => handleLinkClick(e, '#schedule')}>Schedule</a></li>
              <li><a href="#sponsors" onClick={(e) => handleLinkClick(e, '#sponsors')}>Sponsors</a></li>
        ...
        <div className={styles.footerBottom}>
          <div className={styles.legalInfo}>
            ...
            <p className={styles.kicker}>
              Learn more at <a href="https://www.ted.com/tedx" target="_blank" rel="noopener noreferrer">ted.com/tedx</a>.
            </p>
          </div>
